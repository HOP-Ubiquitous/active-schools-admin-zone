...
angular.module('activeSchoolsAdminZoneApp')
  .controller('newRouteCtrl', ['$location', '$window', '$routeParams', 'routeServiceData', 'challengeServiceData',
    function ($location, $window, $routeParams, routeServiceData, challengeServiceData) {
