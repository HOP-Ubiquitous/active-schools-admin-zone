...
app.controller('editProfileCtrl', ['$scope', '$location', 'userService', 'userServiceData', '$routeParams', 'ICONS', 'languageService',
    ...
    vm.editProfile = function () {
      ...
      if ((vm.user.rol !== undefined && vm.user.rol !== '') &&
          ...
          (vm.user.personal_data.country !== undefined && vm.user.personal_data.country !== '')) {
            ...
            userService.editUser(vm.user.user_id, userEdited, 'profile');
